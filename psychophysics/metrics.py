...
def get_lpips(device: torch.device, net: str = 'alex') -> callable:
    """
...
if __name__ == "__main__":
    ...
    print(f"Perceptual similarity (should be symmetric and 0 on diagonal): {lpips_metric(img_a, img_a)[:, :, 0]}")
